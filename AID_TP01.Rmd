...
Mediante la combinacion `purrr::map` y ``purrr::reduce` aplico la funcion de limpieza
a la lista de los tres data frames, y luego los combino usando `dplyr::bind_rows`.
