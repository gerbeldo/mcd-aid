...
cargas por medios tecnologicos) por ceros. Almaceno todo en `db_1`.
...
regargas y montos en cada nivel de clasificacion.
...
Como monto total es una variable en principio continua (a diferencia de cantidad de recargas),
es correcto realizar un grafico de densidades
...
chiquito el tamaño del punto use. (probe tambien hacer un subsampleo
...
en el 4 no, la nube tiende esta mas desplazada hacia abajo (montos menore)
